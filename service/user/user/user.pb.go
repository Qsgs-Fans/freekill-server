...
func (x *ConnIdMsg) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
const file_proto_user_proto_rawDesc = "" +
	...
	"\x06connIp\x18\x02 \x01(\fR\x06connIp\x12\x16\n" +
	"\x06userId\x18\x03 \x01(\x03R\x06userId\"\xbe\x01\n" +
	...
	"\n" +
	"LoginReply\x12\x16\n" +
	"\x06aesKey\x18\x01 \x01(\fR\x06aesKey\x12\x16\n" +
	"\x06userId\x18\x02 \x01(\x03R\x06userId2p\n" +
	"\x04User\x12!\n" +
	"\aNewConn\x12\n" +
	".ConnIdMsg\x1a\n" +
	".UserEmpty\x12#\n" +
